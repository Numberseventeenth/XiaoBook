					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="新建"
												onclick="location.href='${pageContext.request.contextPath}/export/exportExcelByMember.do'">
							...
							<div class="box-tools pull-right">
								<form action="${pageContext.request.contextPath}/member/query.do" method="post">
									根据
									<select name="queryId">
									...
									<c:forEach items="${pageInfo.list}" var="member">
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/member/findById.do?id=${member.m_id}'">详情</button>
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/member/updateById.do?id=${member.m_id}'">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
